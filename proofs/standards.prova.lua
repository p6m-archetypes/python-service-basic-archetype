--- The p6m platform standards, held against the python BASIC service archetype.
---
...
--- network. Docker is the single requirement — no Python on the host, so this suite behaves
...
prova.group("python-basic: the archetype itself", function(g)
